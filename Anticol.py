...
def main():
    ...
    mf_reader = MFRC522.MFRC522(device=0)

    # Welcome message
    print("Welcome to the MFRC522(%s) port of nfc-anticol")
...
def anticol(mf_reader: MFRC522, print_info = True, wakeup = False, no_rats = False):
    # Scan for cards
    (status, atqa, _) = mf_reader.MFRC522_Request(mf_reader.PICC_WUPA if wakeup else mf_reader.PICC_REQALL)
